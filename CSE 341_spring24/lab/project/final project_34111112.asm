...
MAIN PROC
    ...
    SUB BH, 48  ;Convert the ASCII character representing the digit to its numeric 
    
    ;Compare the user's choice (stored in BH) with the numeric values for each arithmetic operation.
    
    CMP BH, 1   
    JE ADDITION  ;when comparison matches a specific operation, jump to the corresponding section of code to perform that operation.
